...
const totalComments = (coment) => {
  return coment !== undefined && coment.Comentarios.length
    ? coment.Comentarios.length
    : 0;
};
      ...
      <View style={styles.infoContainer}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={{ textAlign: "justify" }}>
            {delimiteDescription(ruta.Descripcion)}
          </Text>
        </View>
        <Pressable
          onPress={() => {
            console.log("visitando los comentarios");
