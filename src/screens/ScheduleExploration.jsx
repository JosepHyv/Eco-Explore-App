...
const EditProfile = ({ route }) => {
	const { explorers = [
		{
			...
			profileImageUri: "https://yt3.ggpht.com/yti/AGOGRCrF5eeibUitEoHaE6WPWO1jV8yMh5hQeBN4YKessLk=s108-c-k-c0x00ffffff-no-rj", 
		}
	] } = route.params || {};
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<View style={styles.inputLabel}>
				<SearchBar placeholder="Buscar exploradores" onTextChange={(content) => console.log("Filtrando", content)} />
